      ...
      <div className="flex-grow flex items-center w-auto ">
        ...
        <div>
          ...
          <a
            ...
            className={
              seeLogin
                ? `transition-all duration-500 text-center inline-block text-lg px-16 py-4 rounded-full text-turquoise bg-white border-turquoise border-2 hover:text-white hover:bg-turquoise mt-4 mr-2 lg:mr-3 xl:mr-12 lg:mt-0`
                : `transition-all duration-500 text-center inline-block text-lg px-16 py-4 rounded-full text-white bg-white border-white border-0 hover:text-white hover:bg-white mt-4 mr-2 lg:mr-3 xl:mr-12 lg:mt-0`
            }
          >
            Log In
          </a>
